...
namespace Netbanking.RemessaArquivo.API.Services
{
    ...
    public class RemessaService
    {
        ...
        public static async Task<ActionResult<RemessaItem>> Validador(RemessaItem remessaItem)
            {
            foreach (string linha in new LineReader(() => new StringReader(remessaItem.arquivo)))     
            {
                HttpResponseMessage response = await _client.GetAsync(
                $"https://www.google.com/search?q=a{remessaItem.Id}");
        ...
        public static implicit operator RemessaService(string v)
        {
